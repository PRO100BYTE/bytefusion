    ...
    return (
      <main className="content">
        <MessageDisplay
          ...
          desc="Попробуйте использовать правильные фильтры или ключевые слова"
        />
      </main>
    );
  }
            ...
            {!store.requestStatus && (
              <div className="product-list-header">
                <div className="product-list-header-title">
                  <h5>
                    {`Нашли ${store.products.length} ${store.products.length > 1 ? 'товаров' : 'товар'} с ключевыми словами ${searchKey}`}
                  </h5>
                </div>
              </div>
            )}

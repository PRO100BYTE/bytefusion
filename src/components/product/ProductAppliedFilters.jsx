        ...
        <div className="product-list-header-title">
          <h5>
            {filteredProductsCount > 0
              && `Нашли ${filteredProductsCount} ${filteredProductsCount > 1 ? 'товаров' : 'товар'}`}
          </h5>
        </div>
      </div>
      <div className="product-applied-filters">
        {filter.keyword && (
          <div className="pill-wrapper">
            <span className="d-block">Ключевые слова</span>
        ...
        {filter.brand && (
          <div className="pill-wrapper">
            <span className="d-block">Бренд</span>
            <div className="pill padding-right-l">
        ...
        {(!!filter.minPrice || !!filter.maxPrice) && (
          <div className="pill-wrapper">
            <span className="d-block">Ценовой диапазон</span>
            <div className="pill padding-right-l">
        ...
        {filter.sortBy && (
          <div className="pill-wrapper">
            <span className="d-block">Сортировка</span>
            <div className="pill padding-right-l">
              <h5 className="pill-content margin-0">
